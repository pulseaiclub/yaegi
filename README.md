...
[![release](https://img.shields.io/github/tag-date/pulseaiclub/yaegi.svg?label=alpha)](https://github.com/pulseaiclub/yaegi/releases)
[![Build Status](https://github.com/pulseaiclub/yaegi/actions/workflows/main.yml/badge.svg)](https://github.com/pulseaiclub/yaegi/actions/workflows/main.yml)
[![GoDoc](https://godoc.org/github.com/pulseaiclub/yaegi?status.svg)](https://pkg.go.dev/mod/github.com/pulseaiclub/yaegi)
...
```go
import "github.com/pulseaiclub/yaegi/interp"
```

### Command-line executable

```bash
go install github.com/pulseaiclub/yaegi/cmd/yaegi@latest
```
...
```bash
curl -sfL https://raw.githubusercontent.com/pulseaiclub/yaegi/master/install.sh | bash -s -- -b $GOPATH/bin v0.9.0
```
...
```console
$ yaegi -syscall -unsafe -unrestricted github.com/pulseaiclub/yaegi/cmd/yaegi
>
```
...
Go modules are not supported yet. Until that, it is necessary to install the source into `$GOPATH/src/github.com/pulseaiclub/yaegi` to pass all the tests.
...
[docs]: https://pkg.go.dev/github.com/pulseaiclub/yaegi
[license]: https://github.com/pulseaiclub/yaegi/blob/master/LICENSE
[github]: https://github.com/pulseaiclub/yaegi
[bugs]: https://github.com/pulseaiclub/yaegi/issues?q=is%3Aissue+is%3Aopen+label%3Abug
